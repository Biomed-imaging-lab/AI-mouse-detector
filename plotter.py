...
class Plotter:
    ...
    def plot_trajectory(self):
        ...
        plt.scatter(start_x, start_y, color='white', edgecolor='black', zorder=5, s=65, label="Start")  # Белый круг
    ...
    def plot_position_heatmap(self):
        ...
        im = plt.imshow(heatmap.T, origin='lower', cmap='plasma', interpolation='bilinear', extent=extent)
